...
- **命題ネットワーク(propositional network)**
  ...
  - **命題(proposition)**：哲学用語で場合により少しずつ意味が違う。ここでは「文が表している内容」
...
- **自然カテゴリー(natural category)**：日常生活で使っているカテゴリー
...
- 人間の方式は連想記憶という方式を取っている
  - associative memory、もしくはcontent-addressable memory＝内容を呼び出すことができる記憶
    - 番地を介さず、直接内容を呼び出す
